...
# Adds the special_compile_def to testname and to COMPILE_DEFINITIONS
FUNCTION (X_ADD_COMPILEDEF_TESTCASE targetname the_libraries special_compile_def)
...
# CMake function to add compile target, linking, ADD_TEST directives.
# Invokes X_ADD_COMPILEDEF_TESTCASE if extra arguments are specified
FUNCTION (X_ADD_TESTCASE targetname the_libraries)
   ...
   foreach(f ${ARGN})
            X_ADD_COMPILEDEF_TESTCASE (${targetname} ${the_libraries} ${f})
   endforeach(f)
ENDFUNCTION()
