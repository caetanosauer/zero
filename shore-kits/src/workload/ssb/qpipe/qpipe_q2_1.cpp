...
struct q21_join_s_tuple {
    int LO_ORDERDATE;
    int LO_PARTKEY;
    int LO_REVENUE;
};

struct q21_join_s_p_tuple {
    int LO_ORDERDATE;
    char P_BRAND[10];
    int LO_REVENUE;
};

struct q21_join_tuple {
    char P_BRAND[10];
    int D_YEAR;
    int LO_REVENUE;
};

struct q21_aggregate_tuple {
    char P_BRAND[10];
    int D_YEAR;
    int REVENUE;
};
...
typedef struct q21_aggregate_tuple projected_tuple;

class q21_lineorder_tscan_filter_t : public tuple_filter_t {
private:
    ShoreSSBEnv* _ssbdb;
    table_row_t* _prline;
    rep_row_t _rr;
...
public:
    ...
    q21_lineorder_tscan_filter_t(ShoreSSBEnv* ssbdb)//,q2_1_input_t &in) 
    ...
    void project(tuple_t &d, const tuple_t &s) {
        ...
        q21_lo_tuple *dest;
        dest = aligned_cast<q21_lo_tuple > (d.data);
    ...
    q21_lineorder_tscan_filter_t* clone() const {
        return new q21_lineorder_tscan_filter_t(*this);
    }

    c_str to_string() const {
        return c_str("q21_lineorder_tscan_filter_t()");
    }
};

class q21_part_tscan_filter_t : public tuple_filter_t {
private:
    ShoreSSBEnv* _ssbdb;
    table_row_t* _prpart;
    rep_row_t _rr;
...
public:
    ...
    q21_part_tscan_filter_t(ShoreSSBEnv* ssbdb, q2_1_input_t &in)
    ...
    void project(tuple_t &d, const tuple_t &s) {
        ...
        q21_p_tuple *dest;
        dest = aligned_cast<q21_p_tuple > (d.data);
    ...
    q21_part_tscan_filter_t* clone() const {
        return new q21_part_tscan_filter_t(*this);
    }

    c_str to_string() const {
        return c_str("q21_part_tscan_filter_t()");
    }
};
...
public:
    ...
    q21_supplier_tscan_filter_t(ShoreSSBEnv* ssbdb, q2_1_input_t &in)
    ...
    void project(tuple_t &d, const tuple_t &s) {
        ...
        q21_s_tuple *dest;
        dest = aligned_cast<q21_s_tuple > (d.data);
    ...
    c_str to_string() const {
        return c_str("q2_1_supplier_tscan_filter_t()");
    }
};

class q21_date_tscan_filter_t : public tuple_filter_t {
private:
    ShoreSSBEnv* _ssbdb;
    table_row_t* _prdate;
    rep_row_t _rr;
...
public:
    ...
    q21_date_tscan_filter_t(ShoreSSBEnv* ssbdb, q2_1_input_t &in)
    ...
    void project(tuple_t &d, const tuple_t &s) {
        ...
        q21_d_tuple *dest;
        dest = aligned_cast<q21_d_tuple > (d.data);
    ...
    q21_date_tscan_filter_t* clone() const {
        return new q21_date_tscan_filter_t(*this);
    }

    c_str to_string() const {
        return c_str("q21_date_tscan_filter_t()");
    }
};
...
struct q21_lo_s_join_t : public tuple_join_t {

    q21_lo_s_join_t()
    : tuple_join_t(sizeof (q21_lo_tuple),
    offsetof(q21_lo_tuple, LO_SUPPKEY),
    sizeof (q21_s_tuple),
    offsetof(q21_s_tuple, S_SUPPKEY),
    sizeof (int),
    sizeof (q21_join_s_tuple)) {
    }
    ...
    virtual void join(tuple_t &dest,
        ...
        q21_lo_tuple* lo = aligned_cast<q21_lo_tuple > (left.data);
        q21_s_tuple* s = aligned_cast<q21_s_tuple > (right.data);
        q21_join_s_tuple* ret = aligned_cast<q21_join_s_tuple > (dest.data);
    ...
    virtual q21_lo_s_join_t * clone() const {
        return new q21_lo_s_join_t(*this);
    }
...
struct q21_lo_s_p_join_t : public tuple_join_t {

    q21_lo_s_p_join_t()
    : tuple_join_t(sizeof (q21_join_s_tuple),
    offsetof(q21_join_s_tuple, LO_PARTKEY),
    sizeof (q21_p_tuple),
    offsetof(q21_p_tuple, P_PARTKEY),
    sizeof (int),
    sizeof (q21_join_s_p_tuple)) {
    }
    ...
    virtual void join(tuple_t &dest,
            ...
            const tuple_t & right) {
        // KLUDGE: this projection should go in a separate filter class
        q21_join_s_tuple* jo = aligned_cast<q21_join_s_tuple > (left.data);
        q21_p_tuple* p = aligned_cast<q21_p_tuple > (right.data);
        q21_join_s_p_tuple* ret = aligned_cast<q21_join_s_p_tuple > (dest.data);
    ...
    virtual q21_lo_s_p_join_t * clone() const {
        return new q21_lo_s_p_join_t(*this);
    }
...
struct q21_join_t : public tuple_join_t {

    q21_join_t()
    : tuple_join_t(sizeof (q21_join_s_p_tuple),
    offsetof(q21_join_s_p_tuple, LO_ORDERDATE),
    sizeof (q21_d_tuple),
    offsetof(q21_d_tuple, D_DATEKEY),
    sizeof (int),
    sizeof (q21_join_tuple)) {
    }
    ...
    virtual void join(tuple_t &dest,
            ...
            const tuple_t & right) {
        // KLUDGE: this projection should go in a separate filter class
        q21_join_s_p_tuple* jo = aligned_cast<q21_join_s_p_tuple > (left.data);
        q21_d_tuple* d = aligned_cast<q21_d_tuple > (right.data);
        q21_join_tuple* ret = aligned_cast<q21_join_tuple > (dest.data);
    ...
    virtual q21_join_t * clone() const {
        return new q21_join_t(*this);
    }
...
struct q21_agg_input_tuple_key {
...
struct q21_agg_input_tuple_key_extractor_t : public key_extractor_t {

    q21_agg_input_tuple_key_extractor_t() : key_extractor_t(sizeof (q21_agg_input_tuple_key), offsetof(q21_join_tuple, P_BRAND)) {
    }

    virtual int extract_hint(const char* key) const {
        q21_agg_input_tuple_key* aligned_key = aligned_cast<q21_agg_input_tuple_key > (key);
    ...
    virtual q21_agg_input_tuple_key_extractor_t * clone() const {
        return new q21_agg_input_tuple_key_extractor_t(*this);
    }
};

struct q21_agg_input_tuple_key_compare_t : public key_compare_t {

    virtual int operator()(const void* key1, const void* key2) const {
        q21_agg_input_tuple_key* a = aligned_cast<q21_agg_input_tuple_key > (key1);
        q21_agg_input_tuple_key* b = aligned_cast<q21_agg_input_tuple_key > (key2);
    ...
    virtual q21_agg_input_tuple_key_compare_t * clone() const {
        return new q21_agg_input_tuple_key_compare_t(*this);
    }
};

// Aggregate's tuple's key is the same as the input tuple's key.
typedef struct q21_agg_input_tuple_key q21_agg_tuple_key;

class q21_agg_aggregate_t : public tuple_aggregate_t {
private:

    struct q21_agg_output_tuple_key_extractor_t : public key_extractor_t {

        q21_agg_output_tuple_key_extractor_t() : key_extractor_t(sizeof (q21_agg_tuple_key), offsetof(q21_aggregate_tuple, P_BRAND)) {
        }

        virtual int extract_hint(const char* key) const {
            q21_agg_tuple_key* aligned_key = aligned_cast<q21_agg_tuple_key > (key);
            return aligned_key->extract_hint();
        }

        virtual q21_agg_output_tuple_key_extractor_t * clone() const {
            return new q21_agg_output_tuple_key_extractor_t(*this);
        }
    };

    q21_agg_output_tuple_key_extractor_t _extractor;

public:

    q21_agg_aggregate_t()
    : tuple_aggregate_t(sizeof (q21_aggregate_tuple)) {
    }
    ...
    void aggregate(char* agg_data, const tuple_t &s) {
        q21_join_tuple *src;
        src = aligned_cast<q21_join_tuple > (s.data);
        q21_aggregate_tuple* tuple = aligned_cast<q21_aggregate_tuple > (agg_data);
    ...
    void finish(tuple_t &d, const char* agg_data) {
        q21_aggregate_tuple *dest;
        dest = aligned_cast<q21_aggregate_tuple > (d.data);
        q21_aggregate_tuple* tuple = aligned_cast<q21_aggregate_tuple > (agg_data);

        *dest = *tuple;
    }

    q21_agg_aggregate_t* clone() const {
        return new q21_agg_aggregate_t(*this);
    }

    c_str to_string() const {
        return "q21_agg_aggregate_t";
    }
};
...
struct q21_sort_tuple_key {
    char P_BRAND[STRSIZE(9)];
    int D_YEAR;
    
};

struct q21_order_key_extractor_t : public key_extractor_t {

    q21_order_key_extractor_t() : key_extractor_t(sizeof (q21_sort_tuple_key), offsetof(q21_aggregate_tuple, P_BRAND)) {
    }

    virtual int extract_hint(const char* key) const {
        q21_sort_tuple_key* aligned_key = aligned_cast<q21_sort_tuple_key > (key);
    ...
    virtual q21_order_key_extractor_t * clone() const {
        return new q21_order_key_extractor_t(*this);
    }
};

struct q21_order_key_compare_t : public key_compare_t {

    virtual int operator()(const void* key1, const void* key2) const {
        q21_sort_tuple_key* a = aligned_cast<q21_sort_tuple_key > (key1);
        q21_sort_tuple_key* b = aligned_cast<q21_sort_tuple_key > (key2);
    ...
    virtual q21_order_key_compare_t * clone() const {
        return new q21_order_key_compare_t(*this);
    }
};

class ssb_q21_process_tuple_t : public process_tuple_t {
public:
...
w_rc_t ShoreSSBEnv::xct_qpipe_q2_1(const int xct_id,
    ...
    // TSCAN PACKET
    tuple_fifo* lo_out_buffer = new tuple_fifo(sizeof (q21_lo_tuple));
    tscan_packet_t* lo_tscan_packet =
            new tscan_packet_t("TSCAN LINEORDER",
            lo_out_buffer,
            new q21_lineorder_tscan_filter_t(this),
            this->db(),
    ...
    //SUPPLIER
    tuple_fifo* s_out_buffer = new tuple_fifo(sizeof (q21_s_tuple));
    ...
    //PART
    tuple_fifo* p_out_buffer = new tuple_fifo(sizeof (q21_p_tuple));
    tscan_packet_t* p_tscan_packet =
            new tscan_packet_t("TSCAN PART",
            p_out_buffer,
            new q21_part_tscan_filter_t(this, in),
            this->db(),
            _ppart_desc.get(),
            pxct
            //, SH
    ...
    //DATE
    tuple_fifo* d_out_buffer = new tuple_fifo(sizeof (q21_d_tuple));
    tscan_packet_t* d_tscan_packet =
            new tscan_packet_t("TSCAN DATE",
            d_out_buffer,
            new q21_date_tscan_filter_t(this, in),
            this->db(),
            _pdate_desc.get(),
            pxct
            //, SH
    ...
    tuple_fifo* join_lo_s_out = new tuple_fifo(sizeof (q21_join_s_tuple));
    packet_t* join_lo_s_packet =
            new hash_join_packet_t("Lineorder - Supplier JOIN",
            join_lo_s_out,
            new trivial_filter_t(sizeof (q21_join_s_tuple)),
            lo_tscan_packet,
            s_tscan_packet,
            new q21_lo_s_join_t());

    //JOIN Lineorder and Supplier and Part
    tuple_fifo* join_lo_s_p_out = new tuple_fifo(sizeof (q21_join_s_p_tuple));
    packet_t* join_lo_s_p_packet =
            new hash_join_packet_t("Lineorder - Supplier - Part JOIN",
            join_lo_s_p_out,
            new trivial_filter_t(sizeof (q21_join_s_p_tuple)),
            join_lo_s_packet,
            p_tscan_packet,
            new q21_lo_s_p_join_t());

    //JOIN Lineorder and Supplier and Part and Date
    tuple_fifo* join_out = new tuple_fifo(sizeof (q21_join_tuple));
    packet_t* join_packet =
            new hash_join_packet_t("Lineorder - Supplier - Part - Date JOIN",
            join_out,
            new trivial_filter_t(sizeof (q21_join_tuple)),
            join_lo_s_p_packet,
            d_tscan_packet,
            new q21_join_t());
    ...
    tuple_fifo* agg_output_buffer =
            new tuple_fifo(sizeof (q21_aggregate_tuple));
    packet_t* q21_agg_packet =
            new partial_aggregate_packet_t("AGG Q2_1",
            agg_output_buffer,
            new trivial_filter_t(agg_output_buffer->tuple_size()),
            join_packet,
            new q21_agg_aggregate_t(),
            new q21_agg_input_tuple_key_extractor_t(),
            new q21_agg_input_tuple_key_compare_t());

    
        tuple_fifo* sort_final_out = new tuple_fifo(sizeof(q21_aggregate_tuple));
        packet_t* q21_sort_final_packet =
            new sort_packet_t("ORDER BY D_YEAR ASC, REVENUE DESC",
                                   sort_final_out,
                                   new trivial_filter_t(sizeof(q21_aggregate_tuple)),
                                   new q21_order_key_extractor_t(),
                                   new q21_order_key_compare_t(),
                                   q21_agg_packet);
    ...
    q21_agg_packet->assign_query_state(qs);
    q21_sort_final_packet->assign_query_state(qs);

    // Dispatch packet
    ssb_q21_process_tuple_t pt;
    process_query(q21_sort_final_packet, pt);
