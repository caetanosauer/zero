...
#ifndef DBGEN_TPCH_RND_H
#define DBGEN_TPCH_RND_H
...
extern long     nA;     /* the multiplier */
extern long     nM; /* the modulus == 2^31 - 1 */
extern long     nQ;    /* the quotient nM / nA */
extern long     nR;      /* the remainder nM % nA */
