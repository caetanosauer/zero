...
public:
    ...
    asc_sort_buffer_t(const uint_t field_count)
...
class asc_sort_man_impl : public table_man_impl<asc_sort_buffer_t>
{    
...
public:
    ...
    asc_sort_man_impl(asc_sort_buffer_t* aSortBufferAsc, rep_row_t* aprow)
        : table_man_impl<asc_sort_buffer_t>(aSortBufferAsc, false),
    ...
    w_rc_t get_asc_sort_iter(ss_m* db, asc_sort_iter_impl* &asc_sort_iter);
    w_rc_t get_sort_iter(ss_m* db, asc_sort_iter_impl* &sort_iter);
...
typedef tuple_iter_t<asc_sort_buffer_t, int, table_row_t > asc_sort_scan_t;

class asc_sort_iter_impl : public asc_sort_scan_t 
{
public:
...
public:
    ...
    asc_sort_iter_impl(ss_m* db, asc_sort_buffer_t* psortbuf, asc_sort_man_impl* psortman)
        : tuple_iter_t<asc_sort_buffer_t, int, table_row_t >(db, psortbuf, NL, false), 
...
inline w_rc_t asc_sort_iter_impl::next(ss_m* /* db */, bool& eof, table_tuple& tuple)  
{
    assert(_opened);
