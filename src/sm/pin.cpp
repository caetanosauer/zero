...
rc_t pin_i::pin(const rid_t& rid, smsize_t start, okvl_mode::element_lock_mode lmode,
...
rc_t pin_i::pin(const rid_t& rid, smsize_t start, 
        okvl_mode::element_lock_mode lmode, latch_mode_t latch_mode)
{
...
rc_t pin_i::repin(okvl_mode::element_lock_mode lmode)
{
