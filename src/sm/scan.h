...
-------------------------------------------------------------------
    ...
    NORET            scan_index_i(
        ...
        w_okvl::singular_lock_mode mode = w_okvl::S,
...
private:
    ...
    bool                 _skip_nulls;
    concurrency_t        _cc;
    w_okvl::singular_lock_mode _mode;
...
public:
    ...
    NORET            scan_file_i(
        ...
        bool                     prefetch=false,
        w_okvl::singular_lock_mode ignored = w_okvl::S,
        const bool               bIgnoreLatches = false);
...
protected:
    ...
    w_okvl::singular_lock_mode      _page_lock_mode;
    w_okvl::singular_lock_mode      _rec_lock_mode;
